      ...
      <View style={{ padding: 20, gap: 16 }}>
        <View style={{ alignItems: "center", gap: 12 }}>
          ...
          <View style={{ flexDirection: "row", gap: 12 }}>
            <TouchableOpacity onPress={pickImage} style={{ backgroundColor: "#2d7cf0", paddingHorizontal: 14, paddingVertical: 10, borderRadius: 10 }}>
              <Text style={{ color: "white", fontWeight: "800" }}>Cambiar foto</Text>
            </TouchableOpacity>
            {me?.avatarUrl ? (
              <TouchableOpacity onPress={removeImage} style={{ backgroundColor: "#e33", paddingHorizontal: 14, paddingVertical: 10, borderRadius: 10 }}>
